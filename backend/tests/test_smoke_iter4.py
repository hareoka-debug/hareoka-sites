...
BASE_URL = os.environ.get("EXPO_PUBLIC_BACKEND_URL") or "https://direct-link-9.preview.emergentagent.com"
...
class TestRoutes:
    def test_routes_returns_11_with_cors(self, api_client):
        headers = {"Origin": "https://direct-link-9.preview.emergentagent.com"}
        ...
        assert cors in ("*", "https://direct-link-9.preview.emergentagent.com"), f"Unexpected CORS value: {cors}"
    ...
    def test_routes_options_preflight(self, api_client):
        ...
        r = api_client.options(
            ...
            headers={
                "Origin": "https://direct-link-9.preview.emergentagent.com",
